            ...
            <div class="col-md-12">
                <div class="card mb-4">
                    <div class="card-header bg-warning text-dark">
                        <h4 class="mb-0"><i class="bi bi-speedometer2"></i> Dashboard Petugas</h4>
                    </div>
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0"><i class="bi bi-grid"></i> Menu Petugas</h5>
                    </div>
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-4">
                                <a href="/peminjaman" class="btn btn-warning w-100 py-3">
                                    ...
                                    <div class="mt-2">Kelola Peminjaman</div>
                                </a>
                            </div>
                            <div class="col-md-4">
                                <a href="/alat" class="btn btn-success w-100 py-3">
                                    <i class="bi bi-box-seam" style="font-size: 2rem;"></i>
                                    <div class="mt-2">Data Alat</div>
                                </a>
                            </div>
                            <div class="col-md-4">
